...
import { insertBidang } from "src/context/actions/MasterData/Bidang/insertBidang";
...
const TambahBidang = ({ match }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    keterangan: Yup.string().required("Bidang harus diisi!"),
  });

  // Menangani value dari form submit
  const handleFormSubmit = (values) => {
    const formData = new FormData();
    formData.append("nama_bidang", values.bidang);
    ...
    insertBidang(formData, setLoading, showAlertSuccess, showAlertError);
  };
                  ...
                  <CCol xs="12" md="6">
                    <CFormGroup>
                      ...
                      <CInput
                        ...
                        value={values.bidang}
                        className={
                          errors.bidang && touched.bidang ? "is-invalid" : null
                        }
                      />
                      {errors.bidang && touched.bidang && (
                        <div className="invalid-feedback">{errors.bidang}</div>
                      )}
                    </CFormGroup>
                    <CFormGroup>
