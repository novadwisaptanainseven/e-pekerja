...
import { insertPendidikan } from "src/context/actions/Pegawai/Pendidikan/insertPendidikan";
  ...
  const validationSchema = Yup.object().shape({
    ...
    foto_ijazah: Yup.mixed()
      ...
      .test(
        ...
        (value) => value && value.size <= IJAZAH_SIZE
      )
      .test(
        "type",
        "Ekstensi yang diperbolehkan hanya jpg, jpeg, png dan pdf",
        (value) => value && IJAZAH_SUPPORTED_FORMATS.includes(value.type)
      ),
  });
