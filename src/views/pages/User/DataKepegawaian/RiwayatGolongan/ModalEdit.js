...
} from "src/context/actions/UserPage/RiwayatGolongan";
...
const ModalEdit = ({ idPegawai, modalEdit, setModalEdit, dispatch }) => {
  ...
  useEffect(() => {
    if (modalEdit.id) {
      getRiwayatGolonganById(idPegawai, modalEdit.id, setData, setLoading);
    }
  }, [modalEdit, idPegawai]);
